...
#' 
#' @description 
#' Exemplar model without gamma parameter; GCM from Nosofsky 1986
#' 
#' \strong{MODEL:}
#' Exemplar or GCM model 
#' 
...
cat_exemplar <- function(data          = "choose",
                             niter         = 3000, 
                             nwarmup       = 1000, 
                             nchain        = 4,
                             ncore         = 1, 
  ...
  if (modelRegressor) { # model regressors (for model-based neuroimaging, etc.)
    ...
    modelPath <- system.file("stan", "cat_exemplar.stan", package="hBayesDM")  
  }
