...
#' \describe{
#'  \item{\code{model}}{Character string with the name of the model (\code{"ug_bayes"}).}
...
#' 
#' Xiang, T., Lohrenz, T., & Montague, P. R. (2013). Computational Substrates of Norms and Their Violations during Social Exchange. 
#' Journal of Neuroscience, 33(3), 1099-1108. http://doi.org/10.1523/JNEUROSCI.1642-12.2013
#' 
#' @seealso 
