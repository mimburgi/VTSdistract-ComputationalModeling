#' Two-Choice category-learning exemplar model
#' 
#' @description 
#' Exemplar model with gamma parameter (Deterministic); GCM from Nosofsky 1986
#' 
#' \strong{MODEL:}
#' Exemplar or GCM model with gamma
#' 
...
cat_exemplar_gam <- function(data          = "choose",
                             niter         = 3000, 
                             nwarmup       = 1000, 
                             nchain        = 4,
                             ncore         = 1, 
  ...
  if (modelRegressor) { # model regressors (for model-based neuroimaging, etc.)
    ...
    modelPath <- system.file("stan", "cat_exemplar_gam.stan", package="hBayesDM")  
  }
