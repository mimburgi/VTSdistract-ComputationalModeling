data {
  ...
  real dim1[N,T];
  real dim2[N,T];
  real reward[N,T];  // the outcome or correct category
}
  ...
  for (i in 1:N) {
    ...
    SR=(reward[i,t]-minR)/(maxR-minR);
      ...
      if (outcome[i,t]==1){
        ...
        nstim1=nstim1+1;
        Stim1[nstim1,1]=dim1[i,t]+gam[i]*SR*shiftdim1;
        Stim1[nstim1,2]=dim2[i,t]+gam[i]*SR*shiftdim2;
      }
      ...
      if (outcome[i,t]==2){
        ...
        nstim2=nstim2+1;
        Stim2[nstim2,1]=dim1[i,t]+gam[i]*SR*shiftdim1;
        Stim2[nstim2,2]=dim2[i,t]+gam[i]*SR*shiftdim2;
      }             
