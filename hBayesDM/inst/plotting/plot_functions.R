...
plot_bandit2arm_decay <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Decay Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)")))
  h_all = multiplot(h1, h2, cols = ncols)
...
plot_bandit3arm_delta <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)")))
  h_all = multiplot(h1, h2, cols = ncols)
...
plot_bandit3arm3IT_delta <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tauR, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tauR, " (Inverse Temp Relations)")))
  h3 = plotDist(sample = pars$mu_tauF, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tauF, " (Inverse Temp Features )")))
  h4 = plotDist(sample = pars$mu_tauN, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tauN, " (Inverse Temp None)")))
  h_all = multiplot(h1, h2, h3, h4, cols = ncols)
  return(h_all)
}

plot_bandit3arm3ITEVMax_delta <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tauR, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tauR, " (Inverse Temp Relations)")))
  h3 = plotDist(sample = pars$mu_tauF, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tauF, " (Inverse Temp Features )")))
...
plot_bandit3arm_decay <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)")))
  h_all = multiplot(h1, h2, cols = ncols)
...
plot_baseline3arm <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)")))
  h_all = multiplot(h1, h2, cols = ncols)
...
plot_baseline4arm_categorical <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_C1, fontSize = fontSize, binSize = binSize, xLab = expression(paste(Choice1, " (C1)")))
  h2 = plotDist(sample = pars$mu_C2, fontSize = fontSize, binSize = binSize, xLab = expression(paste(Choice2, " (C2)")))
  h3 = plotDist(sample = pars$mu_C3, fontSize = fontSize, binSize = binSize, xLab = expression(paste(Choice3, " (C3)")))
  h4 = plotDist(sample = pars$mu_C4, fontSize = fontSize, binSize = binSize, xLab = expression(paste(Choice4, " (C4)")))
  h_all = multiplot(h1, h2, h3, h4, cols = ncols)
  return(h_all)
}

plot_bandit2arm_deltaP <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)")))
  h3 = plotDist(sample = pars$mu_P, fontSize = fontSize, binSize = binSize, xLab = expression(paste(P, " (Pers. Decay.)")))
  h_all = multiplot(h1, h2, h3, cols = ncols)
  return(h_all)
}

plot_bandit2arm_PEdelta <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)")))
  h_all = multiplot(h1, h2, cols = ncols)
...
plot_bandit2arm_PEdeltaP <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)")))
  h3 = plotDist(sample = pars$mu_P, fontSize = fontSize, binSize = binSize, xLab = expression(paste(P, " (Pers. Decay.)")))
...
plot_bandit2arm_ETonlydelta <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (ET decay)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)")))
  h_all = multiplot(h1, h2, cols = ncols)
  return(h_all)
}

plot_bandit2arm_ETdelta <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)"))) 
  h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "gam (ET decay)")
  h_all = multiplot(h1, h2, h3, cols = ncols)
  return(h_all)
}

plot_bandit2arm_ETdeltaP <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)"))) 
  h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "gam (ET decay)")
  h4 = plotDist(sample = pars$mu_P, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "P (Pers. decay)")
  h_all = multiplot(h1, h2, h3, h4, cols = ncols)
  return(h_all)
}

plot_bandit2arm_ETWdeltaP <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)"))) 
  h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "gam (ET decay)")
...
plot_bandit2arm_RTdeltaP <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)"))) 
  h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "gam (ET decay)")
...
plot_bandit2arm_AvgRdeltaP <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)"))) 
  h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "gam (ET decay)")
...
plot_bandit2arm_ETNestP <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_A, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "A (Learning Rate)")
  h2 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Inverse Temp.)"))) 
  h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "gam (ET decay)")
...
plot_choiceRTNoBeta_ddm <- function( obj, fontSize = 10, ncols = 3, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_alpha, fontSize = fontSize, binSize = binSize, xLab = expression(paste(alpha, " (Boundary)")))
  #h2 = plotDist(sample = pars$mu_beta, fontSize = fontSize, binSize = binSize, xLab = expression(paste(beta, " (Bias)")) )
  h2 = plotDist(sample = pars$mu_delta, fontSize = fontSize, binSize = binSize, xLab = expression(paste(delta, " (Drift rate)")))
  h3 = plotDist(sample = pars$mu_tau, fontSize = fontSize, binSize = binSize, xLab = expression(paste(tau, " (Non-DM time)")))
  h_all = multiplot(h1, h2, h3, cols = ncols)
  return(h_all)
}
...
plot_cat_exemplar <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_wdim1, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "wdim1 (Attention Weight)")
  h2 = plotDist(sample = pars$mu_c, fontSize = fontSize, binSize = binSize, xLab = expression(paste(c, " (sensitivity)")))
  #h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLab = expression(paste(gam, " (gamma.)")))
  h_all = multiplot(h1, h2, cols = ncols)
  return(h_all)
}

plot_cat_exemplar_gam <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_wdim1, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "wdim1 (Attention Weight)")
  h2 = plotDist(sample = pars$mu_c, fontSize = fontSize, binSize = binSize, xLab = expression(paste(c, " (sensitivity)")))
  h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLab = expression(paste(gam, " (gamma.)")))
...
plot_cat_exemplar_shift <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_wdim1, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "wdim1 (Attention Weight)")
  h2 = plotDist(sample = pars$mu_c, fontSize = fontSize, binSize = binSize, xLab = expression(paste(c, " (sensitivity)")))
  h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLab = expression(paste(gam, " (gamma.)")))
...
plot_cat_exemplar_shiftR <- function( obj, fontSize = 10, ncols = 2, binSize = 30 ) {
  pars = obj$parVals
  h1 = plotDist(sample = pars$mu_wdim1, fontSize = fontSize, binSize = binSize, xLim = c(0, 1), xLab = "wdim1 (Attention Weight)")
  h2 = plotDist(sample = pars$mu_c, fontSize = fontSize, binSize = binSize, xLab = expression(paste(c, " (sensitivity)")))
  h3 = plotDist(sample = pars$mu_gam, fontSize = fontSize, binSize = binSize, xLab = expression(paste(gam, " (gamma.)")))
